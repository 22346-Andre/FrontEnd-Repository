          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="nomeDono" className="text-gray-300">Nome do Dono</Label>
                <Input
                  id="nomeDono"
                  name="nomeDono"
              ...
              <div className="space-y-2">
                <Label htmlFor="celular" className="text-gray-300">Celular</Label>
                <Input
                  id="celular"
                  name="celular"
            ...
            <div className="space-y-2">
              <Label htmlFor="razaoSocial" className="text-gray-300">Razão Social</Label>
              <Input
                id="razaoSocial"
                name="razaoSocial"
                placeholder="Mercadinho Silva LTDA"
